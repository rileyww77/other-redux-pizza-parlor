...
SELECT
[x] display all pizzas (from server)
[x] next button that redirects to order details

ORDER
[x] order form for customer
[x] total cost display
[x] nect button for checkout page

CHECKOUT
[x] display user info, array of pizzas
[x] checkout sends all the stuff to server
[x] and brings us back to display

[x] admin page, display list of orders (from server)
...
[] admin page, display list of orders (from server)
